...
export const markNotificationAsReadAndSent = async (notificationId, userId, socket) => {
  try {
    ...
    const recipientSockets = connectedUsers.get(notification.recipient.toString());
    if (recipientSockets) {
...
export const deleteUserNotification = async (notificationId, userId, socket) => {
  try {
