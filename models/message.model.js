...
import { normalizeUserId } from "../utils/globalUtils.js";
...
MessageSchema.statics.getReceivedMessages = async function(userId) {
   ...
   const messages = await this.find(
            { receiver:  normalizeUserId("68b9d38db5eddadb58e344aa") /*userId , status: 'RECEIVED_BY_SERVER'*/ }
     ...
     //   .sort({ createdAt: -1 })
       console.log("Voici le messages de l'utilisateurs dans message.model.js ", messages);
        return messages;
};
